...
import com.asiainfo.chart.fragment.VpSimpleFragment;
import com.asiainfo.chart.view.ViewPagerIndicator;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

public class IndecatorTestActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_indecator);
